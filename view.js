...
var SHELF_HEIGHT = 1466; // 733;  // 733 multiplied by shelf number (0 to 31) gives us the bottom value in pix
var X_ADJUST     = 0.9765;  // the left of each book in the model data must be multiplied by this to match the rendered map
var Y_ADJUST     = 244; //122;
...
books = L.tileLayer('tiles/map_{x}_{y}.png', {
  minZoom: 2,
  maxZoom: 8,
